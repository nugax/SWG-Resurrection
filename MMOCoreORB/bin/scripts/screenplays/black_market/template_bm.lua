...
sp_new_aldera_bm = ScreenPlay:new {
	numberOfActs = 1, 
	questString = "bm_quest_task",
	states = {}, 
}

registerScreenPlay("sp_new_aldera_bm", true)

function sp_new_aldera_bm:start() 
	-- Spawn our character into the world, setting pLarry a pointer variable we can use to check or change his state.
	--******local pLarry = spawnMobile("PLANET", "black_market_dealer", 1, -6555, 0, -4645, -1, 0 )**** LOCATION
