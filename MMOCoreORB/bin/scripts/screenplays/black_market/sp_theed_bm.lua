sp_theed_bm = ScreenPlay:new {
	numberOfActs = 1, 
	questString = "bm_quest_task",
	states = {}, 
}

registerScreenPlay("sp_theed_bm", true)

function sp_theed_bm:start() 
	-- Spawn our character into the world, setting pLarry a pointer variable we can use to check or change his state.
	local pLarry = spawnMobile("naboo", "black_market_dealer", 1, -4805, 6, 4141, -1, 0 )
