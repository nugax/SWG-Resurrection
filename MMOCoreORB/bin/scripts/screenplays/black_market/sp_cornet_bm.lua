...
sp_cornet_bm = ScreenPlay:new {
	numberOfActs = 1, 
	questString = "bm_quest_task",
	states = {}, 
}

registerScreenPlay("sp_cornet_bm", true)

function sp_cornet_bm:start() 
	-- Spawn our character into the world, setting pLarry a pointer variable we can use to check or change his state.
	local pLarry = spawnMobile("corellia", "black_market_dealer", 1, -121, 28, -4696, -1, 0 )
